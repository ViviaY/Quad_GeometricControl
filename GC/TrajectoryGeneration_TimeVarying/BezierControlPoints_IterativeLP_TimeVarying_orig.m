function [Points_Array,R_Array,t_Array,tau, alpha_params] = BezierControlPoints_IterativeLP_TimeVarying_orig(epsilon,alpha,alpha_v,alpha_s,X_Array,Cs,Ds,Ct,Dt,CuArray,DuArray,N_pts,vm,am,L_p,L_v,L_f,m)
...
alpha_params.alpha_v = alpha_v;
alpha_params.alpha_s = alpha_s;
