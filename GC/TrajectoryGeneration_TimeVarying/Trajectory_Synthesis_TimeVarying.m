function generatedTraj = Trajectory_Synthesis_TimeVarying(param, anneal_options, Bounds, save_dir) 
...
tic; 
[Points_Array,R_Array,t_Array, tau] = BezierControlPoints_IterativeLP_TimeVarying(epsilon,alpha,alpha_v,alpha_s,X_Array,Cs,Ds,Ct,Dt,CuArray,DuArray,N_pts,vm,am,L_p, L_v, L_f, mass);             
t_c2=toc;

generatedTraj.C_sample = C_sample;
generatedTraj.Nv = Nv;
generatedTraj.epsilon = epsilon;
generatedTraj.alpha = alpha;
generatedTraj.alpha_s = alpha_s;
generatedTraj.alpha_v = alpha_v;
...
save(fullfile(save_dir, "GeneratedTrajectoryData.mat"), ...
              "alpha","C_sample","Nv","epsilon","alpha_s","alpha_v","N_pts","X_Array","R_Array","Points_Array","t_Array", "tau", ...
               "XulArray","XuuArray","Xtl","Xtu","Xsl","Xsu","t_c1","t_c2",'L_p','L_v','L_f');  
